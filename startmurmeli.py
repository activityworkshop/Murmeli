...
if dbStatus == DbClient.RUNNING_WITHOUT_AUTH:
	print("Database service mongodb is already running without authentication switched on.")
	print("Please stop this mongodb service before running Murmeli.")
	exit()

if not DbClient.isPasswordAvailable():
	if dbStatus == DbClient.RUNNING_SECURE:
		print("Database service mongodb is already running with authentication but we don't have a password.")
		print("Please stop this mongodb service before running Murmeli.")
		exit()
